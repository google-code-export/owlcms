...
public class WinningOrderComparator extends AbstractLifterComparator implements Comparator<Lifter> {
    ...
    /**
     * Normally we use the computed category; but for special tournaments we want to override this. For example, a tournament may feature
     * "beginners" category with special judging rules. It is then possible to assign different registration categories to these persons
     * without messing up the regular competition.
     */
